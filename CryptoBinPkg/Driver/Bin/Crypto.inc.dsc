...
# DO NOT MODIFY
# GENERATED ON: 2025-09-30 15:20:51.260226

[Defines]
!ifndef CRYPTO_SERVICES
 DEFINE CRYPTO_SERVICES = PACKAGE
!endif
!if $(CRYPTO_SERVICES) IN "NONE PACKAGE TINY_SHA MINIMAL_SHA_SM3 SMALL_SHA_RSA STANDARD ALL"
 # we don't have a problem
!else
 !error CRYPTO_SERVICES must be set to one of NONE PACKAGE TINY_SHA MINIMAL_SHA_SM3 SMALL_SHA_RSA STANDARD ALL.
!endif
...
!if $(CRYPTO_SERVICES) == ALL
  DEFINE PEI_CRYPTO_DRIVER_FILE_GUID = 0b2780c6-4608-4dd2-afed-0b8b4e06bd01
  DEFINE DXE_CRYPTO_DRIVER_FILE_GUID = 0b2780c6-4608-4dd2-afed-0b8b4e06bd02
  DEFINE RUNTIMEDXE_CRYPTO_DRIVER_FILE_GUID = 0b2780c6-4608-4dd2-afed-0b8b4e06bd05
  DEFINE SMM_CRYPTO_DRIVER_FILE_GUID = 0b2780c6-4608-4dd2-afed-0b8b4e06bd03
  DEFINE STANDALONEMM_MMSUPERVISOR_CRYPTO_DRIVER_FILE_GUID = 0b2780c6-4608-4dd2-afed-0b8b4e06bd04
  DEFINE STANDALONEMM_CRYPTO_DRIVER_FILE_GUID = 0b2780c6-4608-4dd2-afed-0b8b4e06bd06
!endif
