...
// DO NOT MODIFY
// GENERATED ON: 2025-08-05 20:41:35.797773

const EDKII_CRYPTO_PROTOCOL  mEdkiiCrypto = {
  /// Version
  CryptoServiceGetCryptoVersion,
  // CUSTOM_ORDER functions
  ...
  NULL,
 #endif
 #if _PCD_VALUE_PcdCryptoServicePkcs1v2Decrypt
  Pkcs1v2Decrypt,
 #else
  NULL,
 #endif
  ...
  NULL,
 #endif
 #if _PCD_VALUE_PcdCryptoServiceRsaOaepEncrypt
  RsaOaepEncrypt,
 #else
  NULL,
 #endif
 #if _PCD_VALUE_PcdCryptoServiceRsaOaepDecrypt
  RsaOaepDecrypt,
 #else
  NULL,
 #endif
