...
def generate_platform_files(edk2_crypto_ver: str = "1.0"):
    ...
    for flavor, phase, target, arch in inf_files:
        ...
        inf_ver_string = str(edk2_crypto_ver)
        if "VERSION_MAJOR_MINOR" in os.environ:
            inf_ver_string += f".{os.environ["VERSION_MAJOR_MINOR"]}"
        if "VERSION_PATCH" in os.environ:
            inf_ver_string += f".{os.environ[".VERSION_PATCH"]}"
