...
def get_flavors():
    ...
    return {
        ...
        "STANDARD": {
            "families": ["HMACSHA256", "PKCS", "SHA1", "SHA256", "SHA384", "SHA512", "RANDOM", "TLS", "TLSGET", "TLSSET", "X509", "ASN1", "HKDF", "EC"],
            "individuals": ["RsaPkcs1Verify", "RsaNew", "RsaFree", "RsaSetKey", "RsaOaepEncrypt", "RsaOaepDecrypt", "RsaGetPublicKeyFromX509", "X509GetSubjectName", "X509GetCommonName", "X509CompareDateTime", "X509GetOrganizationName", "X509GetTBSCert", "RsaPssSign", "RsaPssVerify", "EcGetPublicKeyFromX509"],
