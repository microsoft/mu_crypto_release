...
STACK_OF (X509) *X509_build_chain (
                   X509 *target,
                   STACK_OF (X509) *certs,
                   X509_STORE *store,
...
STACK_OF (X509) *X509_STORE_CTX_get1_certs (
                   X509_STORE_CTX *st,
                   const X509_NAME *nm
                   );
STACK_OF (X509_CRL) *X509_STORE_CTX_get1_crls (
                       const X509_STORE_CTX *st,
                       const X509_NAME *nm
                       );
int
