...
OSSL_DEPRECATEDIN_1_1_0 unsigned char *
ASN1_STRING_data (
  ASN1_STRING  *x
  );
...
ASN1_INTEGER *d2i_ASN1_UINTEGER (
                ASN1_INTEGER **a,
