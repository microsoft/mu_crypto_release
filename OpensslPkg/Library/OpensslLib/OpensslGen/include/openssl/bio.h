...
OSSL_DEPRECATEDIN_3_0 BIO_callback_fn
BIO_get_callback (
  const BIO  *b
  );
...
typedef long (*BIO_callback_fn_ex)(
  BIO         *b,
  int         oper,
  const char  *argp,
  size_t      len,
...
BIO_set_tcp_ndelay (
  ...
  #ifndef OPENSSL_NO_DEPRECATED_1_1_0
OSSL_DEPRECATEDIN_1_1_0 struct hostent *
BIO_gethostbyname (
  const char  *name
  );

OSSL_DEPRECATEDIN_1_1_0 int
BIO_get_port (
  const char      *str,
...
int (*BIO_meth_get_write_ex (const BIO_METHOD *biom))(
        BIO *,
        const char *,
        size_t,
        size_t *
