...
#include "SharedCryptDecl.h" // TODO should this be Protocol or Library?
...
typedef struct _SHARED_CRYPTO_PROTOCOL
{
  ...
  // When initializing the protocol, the callee filling in the crypto functions will check the version
