...
def main():
    ...
    if options.c_file:
        ...
        if options.copy:
            ...
            shutil.copyfile(c_file_path, os.path.join(ROOT_DIR, "OpensslPkg", "Driver", "Crypto.c"))
    if options.h_file:
...
def get_crypto_dsc(options, functions):
    ...
    for flavor in flavors:
        ...
        lines.append(f"!include edk2-basecrypto-driver-bin_extdep/Driver/Bin/{flavor_file}")
        lines.append("!endif\n")
...
def generate_platform_files():
    ...
    for flavor, phase, target, arch in inf_files:
        ...
        dsc_ci_lines.append("  edk2-basecrypto-driver-bin_extdep/Driver/Bin/" + inf_filename)
    ...
    for flavor in flavors:
        for phase in phases:
            ...
            for arch in arches:
                ...
                dsc_lines.append(
                    f"    edk2-basecrypto-driver-bin_extdep/Driver/Bin/{inf_start}_{flavor}_{phase}_$(TARGET)_{arch}.inf ")
                dsc_lines.append(" !endif")
            dsc_lines.append("")
            ...
            dsc_lines.append(
                f"      !include edk2-basecrypto-driver-bin_extdep/Driver/Bin/Crypto.pcd.{flavor}.inc.dsc")
            dsc_lines.append("    }")
            dsc_lines.append("!endif\n")
    dsc_lines.append("")
    ...
    for phase in phases:
        ...
        for flavor in flavors:
            ...
            for target in targets:
                ...
                fdf_bb_lines.append(
                    f"    INF  edk2-basecrypto-driver-bin_extdep/Driver/Bin/{inf_start}_{flavor}_{phase}_{target}_$({upper_phase}_CRYPTO_ARCH).inf")
                fdf_bb_lines.append("  !endif")
            fdf_bb_lines.append("!endif\n")
        generate_file_replacement(
